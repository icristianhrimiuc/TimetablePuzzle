...
public class DatabaseInserts {
	...
	public static void main(String[] args) {
		...
		InstructorMeetings InteligentaArtificiala_LeonFlorin_roomAC02 = new InstructorMeetings(0, 0, LeonFlorin,
				roomAC02);
		...
		Offering InteligentaArtificialaLECTURE = new Offering(0, "Inteligenta Artificiala", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListInteligentaArtificialaLECTURE);
		offeringDAO.merge(InteligentaArtificialaLECTURE);

		InstructorMeetings InteligentaArtificiala_CampanuCorina_roomC06 = new InstructorMeetings(0, 0, CampanuCorina,
				roomC06);
		...
		Offering InteligentaArtificialaLABORATORY = new Offering(0, "Inteligenta Artificiala", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListInteligentaArtificialaLABORATORY);
		offeringDAO.merge(InteligentaArtificialaLABORATORY);

		CourseOffering IA = new CourseOffering(0, "Inteligenta Artificiala", "IA", InteligentaArtificialaLECTURE,
				InteligentaArtificialaLABORATORY);
		courseOfferingDAO.merge(IA);

		InstructorMeetings IngineriaProgramarii_LeonFlorin_roomAC02 = new InstructorMeetings(0, 0, LeonFlorin,
				roomAC02);
		...
		Offering IngineriaProgramariiLECTURE = new Offering(0, "Ingineria Programarii", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListIngineriaProgramariiLECTURE);
		offeringDAO.merge(IngineriaProgramariiLECTURE);

		InstructorMeetings IngineriaProgramarii_CampanuCorina_roomC06 = new InstructorMeetings(0, 0, CampanuCorina,
				roomC06);
		...
		Offering IngineriaProgramariiLABORATORY = new Offering(0, "Ingineria Programarii", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListIngineriaProgramariiLABORATORY);
		offeringDAO.merge(IngineriaProgramariiLABORATORY);

		CourseOffering IP = new CourseOffering(0, "Ingineria Programarii", "IP", IngineriaProgramariiLECTURE,
				IngineriaProgramariiLABORATORY);
		courseOfferingDAO.merge(IP);

		InstructorMeetings AlgoritmiParalelisiDistribuiti_CrausMitica_roomAC02 = new InstructorMeetings(0, 0,
				CrausMitica, roomAC02);
		...
		Offering AlgoritmiParalelisiDistribuitiLECTURE = new Offering(0, "Algoritmi Paraleli si Distribuiti", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListAlgoritmiParalelisiDistribuitiLECTURE);
		offeringDAO.merge(AlgoritmiParalelisiDistribuitiLECTURE);

		InstructorMeetings AlgoritmiParalelisiDistribuiti_AlexandrescuAdrian_roomC14 = new InstructorMeetings(0, 0,
		...
		instrmListAlgoritmiParalelisiDistribuitiLABORATORY
				.add(AlgoritmiParalelisiDistribuiti_AlexandrescuAdrian_roomC14);

		Offering AlgoritmiParalelisiDistribuitiLABORATORY = new Offering(0, "Algoritmi Paraleli si Distribuiti", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListAlgoritmiParalelisiDistribuitiLABORATORY);
		offeringDAO.merge(AlgoritmiParalelisiDistribuitiLABORATORY);

		CourseOffering AlPD = new CourseOffering(0, "Algoritmi Paraleli si Distribuiti", "AlPD",
				AlgoritmiParalelisiDistribuitiLECTURE, AlgoritmiParalelisiDistribuitiLABORATORY);
		courseOfferingDAO.merge(AlPD);

		InstructorMeetings ProgramareaClientuluiWeb_CaraimanSimona_roomAC21 = new InstructorMeetings(0, 0,
				CaraimanSimona, roomAC21);
		...
		Offering ProgramareaClientuluiWebLECTURE = new Offering(0, "Programarea Clientului Web", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListProgramareaClientuluiWebLECTURE);
		offeringDAO.merge(ProgramareaClientuluiWebLECTURE);

		InstructorMeetings ProgramareaClientuluiWeb_GavrilescuMarius_roomC01 = new InstructorMeetings(0, 0,
				GavrilescuMarius, roomC01);
		...
		Offering ProgramareaClientuluiWebLABORATORY = new Offering(0, "Programarea Clientului Web", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListProgramareaClientuluiWebLABORATORY);
		offeringDAO.merge(ProgramareaClientuluiWebLABORATORY);

		CourseOffering PCW = new CourseOffering(0, "Programarea Clientului Web", "PCW", ProgramareaClientuluiWebLECTURE,
				ProgramareaClientuluiWebLABORATORY);
		courseOfferingDAO.merge(PCW);

		InstructorMeetings Structurimultiprocesor_StanAndrei_roomAC21 = new InstructorMeetings(0, 0, StanAndrei,
				roomAC21);
		...
		Offering StructurimultiprocesorLECTURE = new Offering(0, "Structuri multiprocesor", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListStructurimultiprocesorLECTURE);
		offeringDAO.merge(StructurimultiprocesorLECTURE);

		InstructorMeetings Structurimultiprocesor_StanAndrei_roomC214 = new InstructorMeetings(0, 0, StanAndrei,
				roomC214);
		...
		Offering StructurimultiprocesorLABORATORY = new Offering(0, "Structuri multiprocesor", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListStructurimultiprocesorLABORATORY);
		offeringDAO.merge(StructurimultiprocesorLABORATORY);

		CourseOffering SM = new CourseOffering(0, "Structuri multiprocesor", "SM", StructurimultiprocesorLECTURE,
				StructurimultiprocesorLABORATORY);
		courseOfferingDAO.merge(SM);

		InstructorMeetings Limbajeformalesitranslatoare_CrausMitica_roomAC02 = new InstructorMeetings(0, 0, CrausMitica,
				roomAC02);
		...
		Offering LimbajeformalesitranslatoareLECTURE = new Offering(0, "Limbaje formale si translatoare", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListLimbajeformalesitranslatoareLECTURE);
		offeringDAO.merge(LimbajeformalesitranslatoareLECTURE);

		InstructorMeetings Limbajeformalesitranslatoare_CrausMitica_roomC04 = new InstructorMeetings(0, 0, CrausMitica,
				roomC04);
		...
		Offering LimbajeformalesitranslatoareLABORATORY = new Offering(0, "Limbaje formale si translatoare", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListLimbajeformalesitranslatoareLABORATORY);
		offeringDAO.merge(LimbajeformalesitranslatoareLABORATORY);

		CourseOffering LFT = new CourseOffering(0, "Limbaje formale si translatoare", "LFT",
				LimbajeformalesitranslatoareLECTURE, LimbajeformalesitranslatoareLABORATORY);
		courseOfferingDAO.merge(LFT);

		InstructorMeetings RegasireaInformatiilorpeWeb_ArchipAlexandru_roomAC02 = new InstructorMeetings(0, 0,
				ArchipAlexandru, roomAC02);
		...
		Offering RegasireaInformatiilorpeWebLECTURE = new Offering(0, "Regasirea Informatiilor pe Web", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListRegasireaInformatiilorpeWebLECTURE);
		offeringDAO.merge(RegasireaInformatiilorpeWebLECTURE);

		InstructorMeetings RegasireaInformatiilorpeWeb_ArchipAlexandru_roomC14 = new InstructorMeetings(0, 0,
				ArchipAlexandru, roomC14);
		...
		Offering RegasireaInformatiilorpeWebLABORATORY = new Offering(0, "Regasirea Informatiilor pe Web", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListRegasireaInformatiilorpeWebLABORATORY);
		offeringDAO.merge(RegasireaInformatiilorpeWebLABORATORY);

		CourseOffering RIW = new CourseOffering(0, "Regasirea Informatiilor pe Web", "RIW",
				RegasireaInformatiilorpeWebLECTURE, RegasireaInformatiilorpeWebLABORATORY);
		courseOfferingDAO.merge(RIW);

		InstructorMeetings Bazededateorientateobiect_GavrilescuMarius_roomAC02 = new InstructorMeetings(0, 0,
				GavrilescuMarius, roomAC02);
		...
		Offering BazededateorientateobiectLECTURE = new Offering(0, "Baze de date orientate obiect", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListBazededateorientateobiectLECTURE);
		offeringDAO.merge(BazededateorientateobiectLECTURE);

		InstructorMeetings Bazededateorientateobiect_GavrilescuMarius_roomC06 = new InstructorMeetings(0, 0,
				GavrilescuMarius, roomC06);
		...
		Offering BazededateorientateobiectLABORATORY = new Offering(0, "Baze de date orientate obiect", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListBazededateorientateobiectLABORATORY);
		offeringDAO.merge(BazededateorientateobiectLABORATORY);

		CourseOffering BDOO = new CourseOffering(0, "Baze de date orientate obiect", "BDOO",
				BazededateorientateobiectLECTURE, BazededateorientateobiectLABORATORY);
		courseOfferingDAO.merge(BDOO);

		InstructorMeetings Sistemedetimpreal_CascavalPetru_roomAC21 = new InstructorMeetings(0, 0, CascavalPetru,
				roomAC21);
		...
		Offering SistemedetimprealLECTURE = new Offering(0, "Sisteme de timp real", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListSistemedetimprealLECTURE);
		offeringDAO.merge(SistemedetimprealLECTURE);

		InstructorMeetings Sistemedetimpreal_CascavalPetru_roomC212 = new InstructorMeetings(0, 0, CascavalPetru,
				roomC212);
		...
		Offering SistemedetimprealLABORATORY = new Offering(0, "Sisteme de timp real", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListSistemedetimprealLABORATORY);
		offeringDAO.merge(SistemedetimprealLABORATORY);

		CourseOffering STR = new CourseOffering(0, "Sisteme de timp real", "STR", SistemedetimprealLECTURE,
				SistemedetimprealLABORATORY);
		courseOfferingDAO.merge(STR);

		InstructorMeetings Elementedegraficaasistatapecalculator_MantaVasile_roomAC02 = new InstructorMeetings(0, 0,
				MantaVasile, roomAC02);

		List<InstructorMeetings> instrmListElementedegraficaasistatapecalculatorLECTURE = new ArrayList<InstructorMeetings>();
		instrmListElementedegraficaasistatapecalculatorLECTURE
				.add(Elementedegraficaasistatapecalculator_MantaVasile_roomAC02);

		Offering ElementedegraficaasistatapecalculatorLECTURE = new Offering(0,
				"Elemente de grafica asistata pe calculator", 2, OfferingType.LECTURE, DatePattern.FULL_TERM,
				instrmListElementedegraficaasistatapecalculatorLECTURE);
		offeringDAO.merge(ElementedegraficaasistatapecalculatorLECTURE);

		InstructorMeetings Elementedegraficaasistatapecalculator_HerghelegiuPaul_roomC213 = new InstructorMeetings(0, 0,
		...
		instrmListElementedegraficaasistatapecalculatorLABORATORY
				.add(Elementedegraficaasistatapecalculator_HerghelegiuPaul_roomC213);

		Offering ElementedegraficaasistatapecalculatorLABORATORY = new Offering(0,
				"Elemente de grafica asistata pe calculator", 2, OfferingType.LABORATORY, DatePattern.FULL_TERM,
				instrmListElementedegraficaasistatapecalculatorLABORATORY);
		offeringDAO.merge(ElementedegraficaasistatapecalculatorLABORATORY);

		CourseOffering EGC = new CourseOffering(0, "Elemente de grafica asistata pe calculator", "EGC",
				ElementedegraficaasistatapecalculatorLECTURE, ElementedegraficaasistatapecalculatorLABORATORY);
		courseOfferingDAO.merge(EGC);

		InstructorMeetings Modelaresisimulare_CascavalPetru_roomAC02 = new InstructorMeetings(0, 0, CascavalPetru,
				roomAC02);
		...
		Offering ModelaresisimulareLECTURE = new Offering(0, "Modelare si simulare", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListModelaresisimulareLECTURE);
		offeringDAO.merge(ModelaresisimulareLECTURE);

		InstructorMeetings Modelaresisimulare_CascavalPetru_roomC212 = new InstructorMeetings(0, 0, CascavalPetru,
				roomC212);
		...
		Offering ModelaresisimulareLABORATORY = new Offering(0, "Modelare si simulare", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListModelaresisimulareLABORATORY);
		offeringDAO.merge(ModelaresisimulareLABORATORY);

		CourseOffering MS = new CourseOffering(0, "Modelare si simulare", "MS", ModelaresisimulareLECTURE,
				ModelaresisimulareLABORATORY);
		courseOfferingDAO.merge(MS);

		InstructorMeetings Achizitionareasiprelucrareadatelor_UngureanuFlorina_roomAC02 = new InstructorMeetings(0, 0,
				UngureanuFlorina, roomAC02);

		List<InstructorMeetings> instrmListAchizitionareasiprelucrareadatelorLECTURE = new ArrayList<InstructorMeetings>();
		instrmListAchizitionareasiprelucrareadatelorLECTURE
				.add(Achizitionareasiprelucrareadatelor_UngureanuFlorina_roomAC02);

		Offering AchizitionareasiprelucrareadatelorLECTURE = new Offering(0, "Achizitionarea si prelucrarea datelor", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListAchizitionareasiprelucrareadatelorLECTURE);
		offeringDAO.merge(AchizitionareasiprelucrareadatelorLECTURE);

		InstructorMeetings Achizitionareasiprelucrareadatelor_UngureanuFlorina_roomC33 = new InstructorMeetings(0, 0,
		...
		instrmListAchizitionareasiprelucrareadatelorLABORATORY
				.add(Achizitionareasiprelucrareadatelor_UngureanuFlorina_roomC33);

		Offering AchizitionareasiprelucrareadatelorLABORATORY = new Offering(0, "Achizitionarea si prelucrarea datelor",
				2, OfferingType.LABORATORY, DatePattern.FULL_TERM,
				instrmListAchizitionareasiprelucrareadatelorLABORATORY);
		offeringDAO.merge(AchizitionareasiprelucrareadatelorLABORATORY);

		CourseOffering APD = new CourseOffering(0, "Achizitionarea si prelucrarea datelor", "APD",
				AchizitionareasiprelucrareadatelorLECTURE, AchizitionareasiprelucrareadatelorLABORATORY);
		courseOfferingDAO.merge(APD);

		InstructorMeetings TehnologiaInformatiei_AlexandrescuAdrian_roomAC02 = new InstructorMeetings(0, 0,
				AlexandrescuAdrian, roomAC02);
		...
		Offering TehnologiaInformatieiLECTURE = new Offering(0, "Tehnologia Informatiei", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListTehnologiaInformatieiLECTURE);
		offeringDAO.merge(TehnologiaInformatieiLECTURE);

		InstructorMeetings TehnologiaInformatiei_AlexandrescuAdrian_roomC211 = new InstructorMeetings(0, 0,
				AlexandrescuAdrian, roomC211);
		...
		Offering TehnologiaInformatieiLABORATORY = new Offering(0, "Tehnologia Informatiei", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListTehnologiaInformatieiLABORATORY);
		offeringDAO.merge(TehnologiaInformatieiLABORATORY);

		CourseOffering TI = new CourseOffering(0, "Tehnologia Informatiei", "TI", TehnologiaInformatieiLECTURE,
				TehnologiaInformatieiLABORATORY);
		courseOfferingDAO.merge(TI);

		InstructorMeetings Reteledecalculatoare_BotezatuNicolae_roomAC02 = new InstructorMeetings(0, 0, BotezatuNicolae,
				roomAC02);
		...
		Offering ReteledecalculatoareLECTURE = new Offering(0, "Retele de calculatoare", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListReteledecalculatoareLECTURE);
		offeringDAO.merge(ReteledecalculatoareLECTURE);

		InstructorMeetings Reteledecalculatoare_BotezatuNicolae_roomC03 = new InstructorMeetings(0, 0, BotezatuNicolae,
				roomC03);
		...
		Offering ReteledecalculatoareLABORATORY = new Offering(0, "Retele de calculatoare", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListReteledecalculatoareLABORATORY);
		offeringDAO.merge(ReteledecalculatoareLABORATORY);

		CourseOffering RC = new CourseOffering(0, "Retele de calculatoare", "RC", ReteledecalculatoareLECTURE,
				ReteledecalculatoareLABORATORY);
		courseOfferingDAO.merge(RC);

		InstructorMeetings Bazededate_ButincuCristian_roomAC02 = new InstructorMeetings(0, 0, ButincuCristian,
				roomAC02);
		...
		Offering BazededateLECTURE = new Offering(0, "Baze de date", 2, OfferingType.LECTURE, DatePattern.FULL_TERM,
				instrmListBazededateLECTURE);
		...
		Offering BazededateLABORATORY = new Offering(0, "Baze de date", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListBazededateLABORATORY);
		...
		InstructorMeetings Sistemedeprelucraregrafica_MantaVasile_roomAC02 = new InstructorMeetings(0, 0, MantaVasile,
				roomAC02);
		...
		Offering SistemedeprelucraregraficaLECTURE = new Offering(0, "Sisteme de prelucrare grafica", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListSistemedeprelucraregraficaLECTURE);
		offeringDAO.merge(SistemedeprelucraregraficaLECTURE);

		InstructorMeetings Sistemedeprelucraregrafica_HerghelegiuPaul_roomC213 = new InstructorMeetings(0, 0,
				HerghelegiuPaul, roomC213);
		...
		Offering SistemedeprelucraregraficaLABORATORY = new Offering(0, "Sisteme de prelucrare grafica", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListSistemedeprelucraregraficaLABORATORY);
		offeringDAO.merge(SistemedeprelucraregraficaLABORATORY);

		CourseOffering SPG = new CourseOffering(0, "Sisteme de prelucrare grafica", "SPG",
				SistemedeprelucraregraficaLECTURE, SistemedeprelucraregraficaLABORATORY);
		courseOfferingDAO.merge(SPG);

		InstructorMeetings Proiectareastructurilorlogiceprogramabile_MonorCatalin_roomAC21 = new InstructorMeetings(0,
				0, MonorCatalin, roomAC21);

		List<InstructorMeetings> instrmListProiectareastructurilorlogiceprogramabileLECTURE = new ArrayList<InstructorMeetings>();
		instrmListProiectareastructurilorlogiceprogramabileLECTURE
				.add(Proiectareastructurilorlogiceprogramabile_MonorCatalin_roomAC21);

		Offering ProiectareastructurilorlogiceprogramabileLECTURE = new Offering(0,
				"Proiectarea structurilor logice programabile", 2, OfferingType.LECTURE, DatePattern.FULL_TERM,
				instrmListProiectareastructurilorlogiceprogramabileLECTURE);
		offeringDAO.merge(ProiectareastructurilorlogiceprogramabileLECTURE);

		InstructorMeetings Proiectareastructurilorlogiceprogramabile_MonorCatalin_roomC28 = new InstructorMeetings(0, 0,
		...
		instrmListProiectareastructurilorlogiceprogramabileLABORATORY
				.add(Proiectareastructurilorlogiceprogramabile_MonorCatalin_roomC28);

		Offering ProiectareastructurilorlogiceprogramabileLABORATORY = new Offering(0,
				"Proiectarea structurilor logice programabile", 2, OfferingType.LABORATORY, DatePattern.FULL_TERM,
				instrmListProiectareastructurilorlogiceprogramabileLABORATORY);
		offeringDAO.merge(ProiectareastructurilorlogiceprogramabileLABORATORY);

		CourseOffering PSLP = new CourseOffering(0, "Proiectarea structurilor logice programabile", "PSLP",
				ProiectareastructurilorlogiceprogramabileLECTURE, ProiectareastructurilorlogiceprogramabileLABORATORY);
		courseOfferingDAO.merge(PSLP);

		InstructorMeetings Proiectareacumicroprocesoare_PantelimonescuFlorin_roomAC21 = new InstructorMeetings(0, 0,
				PantelimonescuFlorin, roomAC21);
		...
		Offering ProiectareacumicroprocesoareLECTURE = new Offering(0, "Proiectarea cu microprocesoare", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListProiectareacumicroprocesoareLECTURE);
		offeringDAO.merge(ProiectareacumicroprocesoareLECTURE);

		InstructorMeetings Proiectareacumicroprocesoare_PantelimonescuFlorin_roomC214 = new InstructorMeetings(0, 0,
		...
		instrmListProiectareacumicroprocesoareLABORATORY
				.add(Proiectareacumicroprocesoare_PantelimonescuFlorin_roomC214);

		Offering ProiectareacumicroprocesoareLABORATORY = new Offering(0, "Proiectarea cu microprocesoare", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListProiectareacumicroprocesoareLABORATORY);
		offeringDAO.merge(ProiectareacumicroprocesoareLABORATORY);

		CourseOffering PM = new CourseOffering(0, "Proiectarea cu microprocesoare", "PM",
				ProiectareacumicroprocesoareLECTURE, ProiectareacumicroprocesoareLABORATORY);
		courseOfferingDAO.merge(PM);

		InstructorMeetings Structuridedate_UngureanuFlorina_roomAC02 = new InstructorMeetings(0, 0, UngureanuFlorina,
				roomAC02);
		...
		Offering StructuridedateLECTURE = new Offering(0, "Structuri de date", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListStructuridedateLECTURE);
		offeringDAO.merge(StructuridedateLECTURE);

		InstructorMeetings Structuridedate_UngureanuFlorina_roomC04 = new InstructorMeetings(0, 0, UngureanuFlorina,
				roomC04);
		...
		Offering StructuridedateLABORATORY = new Offering(0, "Structuri de date", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListStructuridedateLABORATORY);
		offeringDAO.merge(StructuridedateLABORATORY);

		CourseOffering SD = new CourseOffering(0, "Structuri de date", "SD", StructuridedateLECTURE,
				StructuridedateLABORATORY);
		courseOfferingDAO.merge(SD);

		InstructorMeetings Programareorientatapeobiecte_LupuRobert_roomAC02 = new InstructorMeetings(0, 0, LupuRobert,
				roomAC02);
		...
		Offering ProgramareorientatapeobiecteLECTURE = new Offering(0, "Programare orientata pe obiecte", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListProgramareorientatapeobiecteLECTURE);
		offeringDAO.merge(ProgramareorientatapeobiecteLECTURE);

		InstructorMeetings Programareorientatapeobiecte_LupuRobert_roomC04 = new InstructorMeetings(0, 0, LupuRobert,
				roomC04);
		...
		Offering ProgramareorientatapeobiecteLABORATORY = new Offering(0, "Programare orientata pe obiecte", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListProgramareorientatapeobiecteLABORATORY);
		offeringDAO.merge(ProgramareorientatapeobiecteLABORATORY);

		CourseOffering POO = new CourseOffering(0, "Programare orientata pe obiecte", "POO",
				ProgramareorientatapeobiecteLECTURE, ProgramareorientatapeobiecteLABORATORY);
		courseOfferingDAO.merge(POO);

		InstructorMeetings Teoriasistemelor_KloetzerMarius_roomAC02 = new InstructorMeetings(0, 0, KloetzerMarius,
				roomAC02);
		...
		Offering TeoriasistemelorLECTURE = new Offering(0, "Teoria sistemelor", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListTeoriasistemelorLECTURE);
		offeringDAO.merge(TeoriasistemelorLECTURE);

		InstructorMeetings Teoriasistemelor_KloetzerMarius_roomA113 = new InstructorMeetings(0, 0, KloetzerMarius,
				roomA113);
		...
		Offering TeoriasistemelorLABORATORY = new Offering(0, "Teoria sistemelor", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListTeoriasistemelorLABORATORY);
		offeringDAO.merge(TeoriasistemelorLABORATORY);

		CourseOffering TS = new CourseOffering(0, "Teoria sistemelor", "TS", TeoriasistemelorLECTURE,
				TeoriasistemelorLABORATORY);
		courseOfferingDAO.merge(TS);

		InstructorMeetings Arhitecturasistemelordecalcul_StanAndrei_roomT4 = new InstructorMeetings(0, 0, StanAndrei,
				roomT4);
		...
		Offering ArhitecturasistemelordecalculLECTURE = new Offering(0, "Arhitectura sistemelor de calcul", 3,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListArhitecturasistemelordecalculLECTURE);
		offeringDAO.merge(ArhitecturasistemelordecalculLECTURE);

		InstructorMeetings Arhitecturasistemelordecalcul_StanAndrei_roomC33 = new InstructorMeetings(0, 0, StanAndrei,
				roomC33);
		...
		Offering ArhitecturasistemelordecalculLABORATORY = new Offering(0, "Arhitectura sistemelor de calcul", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListArhitecturasistemelordecalculLABORATORY);
		offeringDAO.merge(ArhitecturasistemelordecalculLABORATORY);

		CourseOffering ASC = new CourseOffering(0, "Arhitectura sistemelor de calcul", "ASC",
				ArhitecturasistemelordecalculLECTURE, ArhitecturasistemelordecalculLABORATORY);
		courseOfferingDAO.merge(ASC);

		InstructorMeetings Proiectareaalgoritmilor_CrausMitica_roomT4 = new InstructorMeetings(0, 0, CrausMitica,
				roomT4);
		...
		Offering ProiectareaalgoritmilorLECTURE = new Offering(0, "Proiectarea algoritmilor", 3, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListProiectareaalgoritmilorLECTURE);
		offeringDAO.merge(ProiectareaalgoritmilorLECTURE);

		InstructorMeetings Proiectareaalgoritmilor_CrausMitica_roomC14 = new InstructorMeetings(0, 0, CrausMitica,
				roomC14);
		...
		Offering ProiectareaalgoritmilorLABORATORY = new Offering(0, "Proiectarea algoritmilor", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListProiectareaalgoritmilorLABORATORY);
		offeringDAO.merge(ProiectareaalgoritmilorLABORATORY);

		CourseOffering PA = new CourseOffering(0, "Proiectarea algoritmilor", "PA", ProiectareaalgoritmilorLECTURE,
				ProiectareaalgoritmilorLABORATORY);
		...
		Offering MatematicadiscretaLECTURE = new Offering(0, "Matematica discreta", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListMatematicadiscretaLECTURE);
		...
		Offering MatematicadiscretaLABORATORY = new Offering(0, "Matematica discreta", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListMatematicadiscretaLABORATORY);
		offeringDAO.merge(MatematicadiscretaLABORATORY);

		CourseOffering MD = new CourseOffering(0, "Matematica discreta", "MD", MatematicadiscretaLECTURE,
				MatematicadiscretaLABORATORY);
		courseOfferingDAO.merge(MD);

		InstructorMeetings AlgebrasianalizamatematicaI_StrugariuRadu_roomE1 = new InstructorMeetings(0, 0,
				StrugariuRadu, roomE1);
		...
		Offering AlgebrasianalizamatematicaILECTURE = new Offering(0, "Algebra si analiza matematica I", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListAlgebrasianalizamatematicaILECTURE);
		offeringDAO.merge(AlgebrasianalizamatematicaILECTURE);

		InstructorMeetings AlgebrasianalizamatematicaI_StrugariuRadu_roomAC03 = new InstructorMeetings(0, 0,
				StrugariuRadu, roomAC03);
		...
		Offering AlgebrasianalizamatematicaISEMINARY = new Offering(0, "Algebra si analiza matematica I", 2,
				OfferingType.SEMINARY, DatePattern.FULL_TERM, instrmListAlgebrasianalizamatematicaISEMINARY);
		offeringDAO.merge(AlgebrasianalizamatematicaISEMINARY);

		CourseOffering AAMI = new CourseOffering(0, "Algebra si analiza matematica I", "AAMI",
				AlgebrasianalizamatematicaILECTURE, AlgebrasianalizamatematicaISEMINARY);
		courseOfferingDAO.merge(AAMI);

		InstructorMeetings AlgebrasianalizamatematicaII_PleteaAriadna_roomE1 = new InstructorMeetings(0, 0,
				PleteaAriadna, roomE1);
		...
		Offering AlgebrasianalizamatematicaIILECTURE = new Offering(0, "Algebra si analiza matematica II", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListAlgebrasianalizamatematicaIILECTURE);
		offeringDAO.merge(AlgebrasianalizamatematicaIILECTURE);

		InstructorMeetings AlgebrasianalizamatematicaII_PleteaAriadna_roomAC03 = new InstructorMeetings(0, 0,
				PleteaAriadna, roomAC03);
		...
		Offering AlgebrasianalizamatematicaIISEMINARY = new Offering(0, "Algebra si analiza matematica II", 2,
				OfferingType.SEMINARY, DatePattern.FULL_TERM, instrmListAlgebrasianalizamatematicaIISEMINARY);
		offeringDAO.merge(AlgebrasianalizamatematicaIISEMINARY);

		CourseOffering AAMII = new CourseOffering(0, "Algebra si analiza matematica II", "AAMII",
				AlgebrasianalizamatematicaIILECTURE, AlgebrasianalizamatematicaIISEMINARY);
		courseOfferingDAO.merge(AAMII);

		InstructorMeetings Graficaasistatapecalculator_TomaAnaMaria_roomE1 = new InstructorMeetings(0, 0, TomaAnaMaria,
				roomE1);
		...
		Offering GraficaasistatapecalculatorLECTURE = new Offering(0, "Grafica asistata pe calculator", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListGraficaasistatapecalculatorLECTURE);
		offeringDAO.merge(GraficaasistatapecalculatorLECTURE);

		InstructorMeetings Graficaasistatapecalculator_TomaAnaMaria_roomC04 = new InstructorMeetings(0, 0, TomaAnaMaria,
				roomC04);
		...
		Offering GraficaasistatapecalculatorLABORATORY = new Offering(0, "Grafica asistata pe calculator", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListGraficaasistatapecalculatorLABORATORY);
		offeringDAO.merge(GraficaasistatapecalculatorLABORATORY);

		CourseOffering GAC = new CourseOffering(0, "Grafica asistata pe calculator", "GAC",
				GraficaasistatapecalculatorLECTURE, GraficaasistatapecalculatorLABORATORY);
		courseOfferingDAO.merge(GAC);

		InstructorMeetings Programareacalculatoarelor_SerbanElena_roomE1 = new InstructorMeetings(0, 0, SerbanElena,
				roomE1);
		...
		Offering ProgramareacalculatoarelorLECTURE = new Offering(0, "Programarea calculatoarelor", 2,
				OfferingType.LECTURE, DatePattern.FULL_TERM, instrmListProgramareacalculatoarelorLECTURE);
		offeringDAO.merge(ProgramareacalculatoarelorLECTURE);

		InstructorMeetings Programareacalculatoarelor_SerbanElena_roomC02 = new InstructorMeetings(0, 0, SerbanElena,
				roomC02);
		...
		Offering ProgramareacalculatoarelorLABORATORY = new Offering(0, "Programarea calculatoarelor", 2,
				OfferingType.LABORATORY, DatePattern.FULL_TERM, instrmListProgramareacalculatoarelorLABORATORY);
		offeringDAO.merge(ProgramareacalculatoarelorLABORATORY);

		CourseOffering PC = new CourseOffering(0, "Programarea calculatoarelor", "PC",
				ProgramareacalculatoarelorLECTURE, ProgramareacalculatoarelorLABORATORY);
		...
		Offering MetodenumericeLECTURE = new Offering(0, "Metode numerice", 2, OfferingType.LECTURE,
				DatePattern.FULL_TERM, instrmListMetodenumericeLECTURE);
		...
		Offering MetodenumericeLABORATORY = new Offering(0, "Metode numerice", 2, OfferingType.LABORATORY,
				DatePattern.FULL_TERM, instrmListMetodenumericeLABORATORY);
		offeringDAO.merge(MetodenumericeLABORATORY);

		CourseOffering MN = new CourseOffering(0, "Metode numerice", "MN", MetodenumericeLECTURE,
				MetodenumericeLABORATORY);
		...
		Offering FizicaLECTURE = new Offering(0, "Fizica", 3, OfferingType.LECTURE, DatePattern.FULL_TERM,
				instrmListFizicaLECTURE);
		...
		Offering FizicaLABORATORY = new Offering(0, "Fizica", 2, OfferingType.LABORATORY, DatePattern.FULL_TERM,
				instrmListFizicaLABORATORY);
		...
		Curricula AnulPatruSemIC = new Curricula(0, "AnulPatruSemIC", CollegeYear.FOURTH, Term.FIRST,
				AnulPatruSemICCurriculaList);
		...
		Curricula AnulPatruSemITI = new Curricula(0, "AnulPatruSemITI", CollegeYear.FOURTH, Term.FIRST,
				AnulPatruSemITICurriculaList);
		...
		Curricula AnulPatruSemIIC = new Curricula(0, "AnulPatruSemIIC", CollegeYear.FOURTH, Term.SECOND,
				AnulPatruSemIICCurriculaList);
		...
		Curricula AnulPatruSemIITI = new Curricula(0, "AnulPatruSemIITI", CollegeYear.FOURTH, Term.SECOND,
				AnulPatruSemIITICurriculaList);
		...
		Curricula AnulTreiSemIC = new Curricula(0, "AnulTreiSemIC", CollegeYear.THIRD, Term.FIRST,
				AnulTreiSemICCurriculaList);
		...
		Curricula AnulTreiSemITI = new Curricula(0, "AnulTreiSemITI", CollegeYear.THIRD, Term.FIRST,
				AnulTreiSemITICurriculaList);
		...
		Curricula AnulTreiSemIIC = new Curricula(0, "AnulTreiSemIIC", CollegeYear.THIRD, Term.SECOND,
				AnulTreiSemIICCurriculaList);
		...
		Curricula AnulTreiSemIITI = new Curricula(0, "AnulTreiSemIITI", CollegeYear.THIRD, Term.SECOND,
				AnulTreiSemIITICurriculaList);
		...
		Curricula AnulDoiSemICTI = new Curricula(0, "AnulDoiSemICTI", CollegeYear.SECOND, Term.FIRST,
				AnulDoiSemICTICurriculaList);
		...
		Curricula AnulDoiSemIICTI = new Curricula(0, "AnulDoiSemIICTI", CollegeYear.SECOND, Term.SECOND,
				AnulDoiSemIICTICurriculaList);
		...
		Curricula AnulIntaiSemICTI = new Curricula(0, "AnulIntaiSemICTI", CollegeYear.FIRST, Term.FIRST,
				AnulIntaiSemICTICurriculaList);
		...
		Curricula AnulIntaiSemIICTI = new Curricula(0, "AnulIntaiSemIICTI", CollegeYear.FIRST, Term.SECOND,
				AnulIntaiSemIICTICurriculaList);
		curriculaDAO.merge(AnulIntaiSemIICTI);

		SubjectAreaDAO subjectAreaDAO = new SubjectAreaJPADAOService();

		SubjectArea AnulPatruC = new SubjectArea(0, "AnulPatruC", "C-IV", AnulPatruSemIC, AnulPatruSemIIC);
		subjectAreaDAO.merge(AnulPatruC);

		SubjectArea AnulPatruTI = new SubjectArea(0, "AnulPatruTI", "TI-IV", AnulPatruSemITI, AnulPatruSemIITI);
		subjectAreaDAO.merge(AnulPatruTI);

		SubjectArea AnulTreiC = new SubjectArea(0, "AnulTreiC", "C-III", AnulTreiSemIC, AnulTreiSemIIC);
		subjectAreaDAO.merge(AnulTreiC);

		SubjectArea AnulTreiTI = new SubjectArea(0, "AnulTreiTI", "TI-III", AnulTreiSemITI, AnulTreiSemIITI);
		subjectAreaDAO.merge(AnulTreiTI);

		SubjectArea AnulDoiCTI = new SubjectArea(0, "AnulDoiCTI", "CTI-II", AnulDoiSemICTI, AnulDoiSemIICTI);
		subjectAreaDAO.merge(AnulDoiCTI);

		SubjectArea AnulIntaiCTI = new SubjectArea(0, "AnulIntaiCTI", "CTI-I", AnulIntaiSemICTI, AnulIntaiSemIICTI);
		subjectAreaDAO.merge(AnulIntaiCTI);

		YearOfStudyDAO yearOfStudyDAO = new YearOfStudyJPADAOService();

		List<SubjectArea> subjectAreasListForAnulPatru = new ArrayList<SubjectArea>();
		subjectAreasListForAnulPatru.add(AnulPatruC);
		subjectAreasListForAnulPatru.add(AnulPatruTI);

		YearOfStudy AnulPatru = new YearOfStudy(0, "AnulPatru", CollegeYear.FOURTH, subjectAreasListForAnulPatru);
		yearOfStudyDAO.merge(AnulPatru);

		List<SubjectArea> subjectAreasListForAnulTrei = new ArrayList<SubjectArea>();
		subjectAreasListForAnulTrei.add(AnulTreiC);
		subjectAreasListForAnulTrei.add(AnulTreiTI);

		YearOfStudy AnulTrei = new YearOfStudy(0, "AnulTrei", CollegeYear.THIRD, subjectAreasListForAnulTrei);
		yearOfStudyDAO.merge(AnulTrei);

		List<SubjectArea> subjectAreasListForAnulDoi = new ArrayList<SubjectArea>();
		subjectAreasListForAnulDoi.add(AnulDoiCTI);

		YearOfStudy AnulDoi = new YearOfStudy(0, "AnulDoi", CollegeYear.SECOND, subjectAreasListForAnulDoi);
		yearOfStudyDAO.merge(AnulDoi);

		List<SubjectArea> subjectAreasListForAnulIntai = new ArrayList<SubjectArea>();
		subjectAreasListForAnulIntai.add(AnulIntaiCTI);

		YearOfStudy AnulIntai = new YearOfStudy(0, "AnulIntai", CollegeYear.FIRST, subjectAreasListForAnulIntai);
		yearOfStudyDAO.merge(AnulIntai);

		DepartmentDAO departmentDAO = new DepartmentJPADAOService();

		List<YearOfStudy> yearsOfStudyListForCTI = new ArrayList<YearOfStudy>();
		yearsOfStudyListForCTI.add(AnulPatru);
		yearsOfStudyListForCTI.add(AnulTrei);
		yearsOfStudyListForCTI.add(AnulDoi);
		yearsOfStudyListForCTI.add(AnulIntai);
