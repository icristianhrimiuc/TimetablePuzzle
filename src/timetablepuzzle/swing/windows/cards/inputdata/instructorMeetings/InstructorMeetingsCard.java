...
import timetablepuzzle.eclipselink.DAO.JPA.services.inputdata.InstructorMeetingsJPADAOService;
...
import timetablepuzzle.eclipselink.DAO.interfaces.inputdata.InstructorMeetingsDAO;
...
public class InstructorMeetingsCard extends JPanel {
	...
	public InstructorMeetingsCard(Color backgroundColor) {
		...
		this.instructorsMeetingsTable.setDefaultRenderer(String.class, defaultRenderer);
		SetColumnsMaxSizes();
		...
		this.textFieldNrOfMeetings = CreatePropertyTextField(10);
	...
	private void SetColumnsMaxSizes() {
		...
		this.instructorsMeetingsTable.getColumnModel().getColumn(3).setMinWidth(100);
		this.instructorsMeetingsTable.getColumnModel().getColumn(3).setMaxWidth(100);
	}
